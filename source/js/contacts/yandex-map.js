window.addEventListener('load', function() {
  ...
  function init(){
    ...
    myPlacemark = new ymaps.Placemark([55.82647694866468,49.139917029444426], {
        // hintContent: 'Москва!',
...
// ++++++++++++++++++++++++
    ...
    // list
    const calibrationList = document.querySelector(".contacts__left-contacts-list")
    // list sizes
    const calibrationListTop = calibrationList.offsetTop
    // map
    const map = document.querySelector("#map")
    // left side
    const leftSide = document.querySelector(".contacts__left")
    // map height
