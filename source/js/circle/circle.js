window.addEventListener('load', function() {
  ...
  const circleArrowSalad = document.querySelector(".progress-circle-arrow--salad")
  const circleArrowBlack = document.querySelector(".progress-circle-arrow--black")
...
// sections
  window.addEventListener("scroll", () => {
    ...
    try {
      aboutUsTop = document.querySelector(".about-us").offsetTop
      services = document.querySelector(".services").offsetTop
      products = document.querySelector(".products").offsetTop
    ...
    if (currentPosition >= aboutUsTop && aboutUsTop) {
      clearArrowsClasses()
    ...
    // services
    if (currentPosition >= services && services) {
      clearArrowsClasses()
    ...
    // products
    if (currentPosition >= products && products) {
      clearArrowsClasses()
