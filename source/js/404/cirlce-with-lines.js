window.addEventListener('load', function() {
  ...
  const circle = document.querySelector(".intro404__decoration-circle-with-lines")
...
// const calibrationTitleLeft = calibrationTitle.getBoundingClientRect().width / 2
  const calibrationTitleParentLeft = calibrationTitle.offsetParent.offsetWidth / 2
