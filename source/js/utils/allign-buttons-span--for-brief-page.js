window.addEventListener('load', function() {
  ...
  allButtons.forEach(button => {
    ...
    if (buttonSpan) {
      ...
      buttonSpan.classList.contains("about-us__right-side-read-more-span--brief-bottom")

      if (buttonSpan.classList.contains("about-us__right-side-read-more-span--brief-bottom")) {
